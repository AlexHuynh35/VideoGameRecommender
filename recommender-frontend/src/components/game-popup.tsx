        ...
        <div className={`fixed inset-0 flex items-center justify-center transition-transform duration-300 ${isOpen ? "translate-x-0 ease-out" : "-translate-x-full ease-in"} z-50`}>
          <div className="relative w-[64rem] h-[80vh] p-6">
            ...
            <div className={`absolute top-4 right-25 w-50 aspect-[8/1] z-50`}>
              <div className="absolute inset-0 bg-neutral-400 shadow-md [clip-path:polygon(0%_0%,10%_0%,10%_20%,90%_20%,90%_0%,100%_0%,100%_100%,0%_100%)] [transform:translateZ(0)] transform-gpu will-change-transform" />
            </div>

            <div className="relative h-full z-40">
              <div className="absolute inset-0 bg-orange-500 translate-x-2 translate-y-2 [clip-path:polygon(0%_10%,10%_0%,100%_0%,100%_90%,90%_100%,0%_100%)] [transform:translateZ(0)] transform-gpu will-change-transform" />
              <div className="absolute inset-0 bg-neutral-200 [clip-path:polygon(0%_10%,10%_0%,100%_0%,100%_90%,90%_100%,0%_100%)] [transform:translateZ(0)] transform-gpu will-change-transform z-40">
